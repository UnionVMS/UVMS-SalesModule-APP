...
public class CompareReportSummaryOnCreationAscendingTest {

    private CompareReportSummaryOnCreationAscending compareReportSummaryOnCreationAscending;

    @Before
    public void init() {
        this.compareReportSummaryOnCreationAscending = new CompareReportSummaryOnCreationAscending();
    }
    ...
    public void compareCase1() throws Exception {
        ...
        Collections.sort(list, compareReportSummaryOnCreationAscending);
