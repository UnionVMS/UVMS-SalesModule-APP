...
public class EcbProxyServiceBean implements EcbProxyService {
    ...
    @Override
    public BigDecimal findExchangeRate(String sourceCurrency, String targetCurrency, DateTime date) throws ServiceException {
        ...
        try {
            ...
            throw new ServiceException("Could not create the request for the ECB proxy", e);
        }
        ...
        try {
            ...
            throw new ServiceException("Could not convert the currency, because something went wrong contacting the ECB Proxy module. Sent message: " + request, e);
        }

    }

    private <T> T callEcbProxy(String request, Class<T> returnType) throws ServiceException {
        try {
            ...
            throw new ServiceException("Could not contact the ECB proxy Module", e);
        }
    }
    ...
    private <T> T unmarshallTextMessage(TextMessage responseText, Class<T> returnType) throws ServiceException {
        try {
            ...
            try {
                throw new ServiceException("Could not interpret the response of the ECB proxy. The repsonse was: " + responseText.getText(), e);
            } catch (JMSException e1) {
                throw new ServiceException("Could not interpret the response of the ECB proxy.", e);
            }
        }
    }
}