...
public class AssetServiceBean implements AssetService {
    ...
    @Override
    public List<Asset> findByNameOrCFROrIRCS(String searchString) throws ServiceException {
    ...
    @Override
    public List<String> findExtIdsByNameOrCFROrIRCS(String searchString) throws ServiceException {
