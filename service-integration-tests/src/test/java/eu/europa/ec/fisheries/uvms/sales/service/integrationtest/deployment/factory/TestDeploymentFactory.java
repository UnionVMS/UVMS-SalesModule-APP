package eu.europa.ec.fisheries.uvms.sales.service.integrationtest.deployment.factory;
...
public class TestDeploymentFactory {
    ...
    private static WebArchive createBasicTestArchive(final String archiveName) {
        ...
        testWar.addPackages(true, "eu.europa.ec.fisheries.uvms.sales.service.integrationtest");
